...
export default function LinksProfileView() {
    ...
    return (
        <>
            ...
            <div className="flex justify-center w-full pt-4"> {/* Contenedor padre */}
                <button
                    className="uppercase inline-flex py-2 px-4 text-sm font-semibold text-white rounded-lg bg-indigo-500 hover:bg-indigo-600 transition-colors duration-300"
